...
//  if ( !!userSettings && store.has(userSettings.skybox) ) {
//      sceneBackground( userSettings.getValue("skybox") );
//  }

    if ( store.has("/user/settings/skybox/current") ){

        sceneBackground( store.get("/user/settings/skybox/current") );
